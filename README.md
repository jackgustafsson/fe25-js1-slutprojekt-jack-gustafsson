...
2. displayContent.js är presentationslagret i applikationen där den översätter rå API-data till användarvänliga HTML-element. Här skapas DOM-strukturer, innehåll för filmer och personer visas och interaktivitet läggs till.

3. functions.js innehåller återanvändbara hjälpfunktioner som förenklar användarupplevelsen. Koden har funktioner som rensar och bygger om DOM:en, styr navigering och visning samt visar meddelanden.
