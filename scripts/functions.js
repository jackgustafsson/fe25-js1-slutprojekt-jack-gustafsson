...
/**
 * functions.js innehåller återanvändbara hjälpfunktioner. 
 * Dessa funktioner kan rensa och bygga om DOM:en, styra navigering och visning av innehåll samt visa upp meddelanden.
 */
